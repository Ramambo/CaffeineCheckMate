...
public class EditMyProfileUpdateHandler extends HttpServlet implements CommandHandler {
	...
	//본인의 파일업로드경로
	//프로필폴더 우클릭 > 프로퍼리 > 로케이션복사 C:\Users\ljh\ccm\CaffeineCheckMate\ccm\src\main\webapp\resources\profile
	public static final String FILE_ROOT_PATH = "C:/Users/USER/git/CaffeineCheckMate/ccm/src/main/webapp/resources/profile";
	// 애플리케이션 루트 경로 얻기
